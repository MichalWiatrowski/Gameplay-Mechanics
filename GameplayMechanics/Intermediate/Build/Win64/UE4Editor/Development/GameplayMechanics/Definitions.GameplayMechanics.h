...
#define ORIGINAL_FILE_NAME "UE4Editor-GameplayMechanics.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME GameplayMechanics
...
#define GAMEPLAYMECHANICS_API DLLEXPORT
